#!/usr/bin/env python3
"""Explain StellaGate Cloud/UI error codes in plain language."""
...
EXPLANATIONS = {
    "invite_invalid": "The invite code is invalid. Ask the Cloud admin for a fresh code.",
    "invite_expired": "The invite code has expired. Ask for a new code.",
    "invite_disabled": "The invite code has been disabled. The Cloud admin must re-enable or replace it.",
    ...
    "activation_revoked": "This VPS authorization was revoked in StellaGate-Cloud.",
    ...
    "revoked": "This VPS authorization was revoked in StellaGate-Cloud.",
    "expired": "This VPS authorization expired and must be renewed.",
    "cloud_unreachable": "The VPS cannot reach StellaGate-Cloud right now.",
    "cloud_timeout": "StellaGate-Cloud timed out. Retry after checking network and Cloud health.",
    "cloud_version_mismatch": "StellaGate-Cloud and StellaGate-UI are using incompatible API versions.",
    "cloud_not_configured": "StellaGate-UI does not have a Cloud address configured.",
    "invalid_cloud_url": "The Cloud URL is invalid. Use a full HTTPS URL.",
    "cloud_url_must_be_https": "The Cloud URL must use HTTPS unless it is localhost development.",
...
def main() -> int:
    ...
    for code in args.code:
        ...
        print(f"{normalized}: {EXPLANATIONS.get(normalized, 'Unknown StellaGate error. Check Cloud/UI logs and API contract drift.')}")
    return 0
